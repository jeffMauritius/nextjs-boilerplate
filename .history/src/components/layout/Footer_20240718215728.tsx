...
export const Footer = () => {
  return (
    <footer className="w-6/8 fixed bottom-0 z-40 m-auto border-card bg-background">
      <div className="m-auto w-full max-w-4xl px-2 ">
        <div className="flex w-full items-center justify-center">
          <div className="flex flex-col gap-6 text-sm text-muted-foreground md:flex-row">
            <Link
