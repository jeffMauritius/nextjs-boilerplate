...
export const Footer = () => {
  return (
    <footer className="fixed bottom-0 z-40 w-full border-t border-card bg-background">
      <div className="m-auto w-full max-w-4xl px-2 py-4">
        <div className="flex w-full items-center justify-center">
          <div className="flex flex-col gap-4 pb-5 text-sm text-muted-foreground md:flex-row">
            <Link
